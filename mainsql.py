...
def create_venta(iduser: int):
    try:    
        with conexion().cursor() as cursor:
            # Execute the stored procedure and fetch the IdVenta returned by the procedure
            print('ola')
            ...
            if result and result[0]:
                id_venta = result[0]  # Extract the IdVenta from the result
            else:
        ...
        # Return a success message with the IdVenta
